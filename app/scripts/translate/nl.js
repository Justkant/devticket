...
.config(function ($translateProvider) {
  $translateProvider.translations('nl', {
    ...
    CHANGE_PWD_MODAL_OLD: 'Oud wachtwoord',
    CHANGE_PWD_MODAL_NEW: 'Nieuw wachtwoord',
